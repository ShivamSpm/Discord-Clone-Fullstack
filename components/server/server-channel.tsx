...
const ServerChannel: React.FC<ServerChannelProps> = ({
  ...
  return (
    ...
    >
      <Icon className="flex-shrink-0 w-4 h-4 text-zinc-500 dark:text-sinc-400" />
      <p
        className={cn(
        ...
        <div className="ml-auto flex items-center gap-x-2">
          <ToolTipAction label="Edit">
            <Edit
              ...
              className="hidden group-hover:block w-3.5 h-3.5 text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300 transition"
            />
          </ToolTipAction>
